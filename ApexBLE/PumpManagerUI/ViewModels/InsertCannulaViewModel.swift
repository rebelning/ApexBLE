...
public protocol CannulaInserter {
    func insertCannula(completion: @escaping (Result<TimeInterval,ApexBLEPumpManagerError>) -> ())
...
extension ApexBLEPumpManager: CannulaInserter {
...
class InsertCannulaViewModel: ObservableObject, Identifiable {
    ...
    enum InsertCannulaViewModelState {
        ...
        case error(ApexBLEPumpManagerError)
        case finished
    ...
    var error: ApexBLEPumpManagerError? {
...
public extension ApexBLEPumpManagerError {
