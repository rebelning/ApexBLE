...
public final class ApexBLEReservoirView: LevelHUDView, NibLoadable {
    ...
    public class func instantiate() -> ApexBLEReservoirView {
        return nib().instantiate(withOwner: nil, options: nil)[0] as! ApexBLEReservoirView
    }
