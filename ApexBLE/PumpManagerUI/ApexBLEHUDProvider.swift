...
internal class ApexBLEHUDProvider: NSObject, HUDProvider {
    ...
    private var reservoirView: ApexBLEReservoirView?
    ...
    public init(pumpManager: ApexBLEPumpManager, bluetoothProvider: BluetoothProvider, colorPalette: LoopUIColorPalette, allowedInsulinTypes: [InsulinType]) {
    ...
    public func createHUDView() -> BaseHUDView? {
        reservoirView = ApexBLEReservoirView.instantiate()
        updateReservoirView()
    ...
    public static func createHUDView(rawValue: HUDProvider.HUDViewRawState) -> BaseHUDView? {
        ...
        let reservoirView: ApexBLEReservoirView?
...
extension ApexBLEHUDProvider: PodStateObserver {
