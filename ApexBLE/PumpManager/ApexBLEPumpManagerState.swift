...
public struct ApexBLEPumpManagerState: RawRepresentable, Equatable {
    ...
    public var rawValue: RawValue {
        var value: [String : Any] = [
            "version": ApexBLEPumpManagerState.version,
...
extension ApexBLEPumpManagerState {
...
extension ApexBLEPumpManagerState: CustomDebugStringConvertible {
    public var debugDescription: String {
        return [
            "## ApexBLEPumpManagerState",
            "* isOnboarded: \(isOnboarded)",
            "* timeZone: \(timeZone)",
